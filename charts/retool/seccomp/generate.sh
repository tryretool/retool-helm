...
JSON
  ...
  local comment="Based on Docker default seccomp profile from ${UPSTREAM_REPO} (https://github.com/${UPSTREAM_REPO}/commit/${UPSTREAM_COMMIT}). Generated by charts/retool/seccomp/generate.sh"
...
JSON
  ...
  local comment="Based on Docker default seccomp profile from ${UPSTREAM_REPO} (https://github.com/${UPSTREAM_REPO}/commit/${UPSTREAM_COMMIT}). Generated by charts/retool/seccomp/generate.sh — defaultErrnoRet changed to ENOSYS (38), archMap narrowed to x86_64 + aarch64 (gVisor supported platforms)."
